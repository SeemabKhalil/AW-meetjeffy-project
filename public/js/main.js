(() => {
	...
	const addMenuBackground = () => {
        ...
        if(pageWidth > mobileWidth) {
            boddyOffset > 0 ? navigation.classList.add("mj-nav-fixed") : navigation.classList.remove("mj-nav-fixed");
        }
	}

	const reorderResponsiveMenu = () => {
        const pageWidth = window.innerWidth;
        const navContainer = document.querySelector("header nav .mj-container");
        const navigation = document.querySelector("header nav .mj-navigation");
        const mobileNavigation = document.querySelector("body > .mj-navigation");
	...
	const mobileMenuToggle = () => {
        const menuToggle = document.querySelector(".mj-nav-toggle");

        menuToggle.addEventListener("click", () =>{
        	const mobileNavigation = document.querySelector("body > .mj-navigation");

        	mobileNavigation.classList.toggle("mj-navigation-opened");
        })
	}

	const onNavItemClick = () => {
		const navItemList = document.querySelectorAll(".mj-section-link");
	...
	const onTestimonialChange = () => {
        ...
        const prevArrow = document.querySelector("#mj-testimonials-prev");
        const nextArrow = document.querySelector("#mj-testimonials-next");
        const testimonials = document.querySelector(".mj-testimonials ul");
	...
	const onGalleryImageClick = () => {
        const galleryImageList = document.querySelectorAll("#mj-gallery li");
	...
	const galleryImageOpen = image => {
		...
		const openedImage = `<div class='mj-backdrop'><img src='${imageSrc}' alt='' />
		                    <span class="mj-backdrop-close">X</span></div>`;
	...
	const galleryImageClose = () => {
		const closeButton = document.querySelector(".mj-backdrop-close");

		closeButton.addEventListener("click", () => {
			const backdrop = document.querySelector(".mj-backdrop");
			backdrop.remove();
		})
	}
